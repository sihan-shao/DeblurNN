...
def evaluate(sharp_image: np.ndarray, z: float) -> np.ndarray:
    ...
    # Evaluation Metrics
    print("Structural Similarity Index: {}".format(batch_PSNR(input, deblurred_img)))
    print("Peak Signal-to-Noise Ratio: {}".format(batch_SSIM(input, deblurred_img)))
